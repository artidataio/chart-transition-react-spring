  ...
  return (
    <>
      ...
      <p>
        ...
        we will use useTransition which has more robust api handle elements that
        is entering and leaving. Here, we can see a fading animation on the
        squares that is leaving the DOM and entering animation too.
      </p>
